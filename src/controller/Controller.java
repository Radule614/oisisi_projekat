...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	{
		TableManager.addRows(0, DataManager.studentiToTableDataArray());
		TableManager.addRows(1, DataManager.profesoriToTableDataArray());
		TableManager.addRows(2, DataManager.predmetiToTableDataArray());
	}
	...
	public static void initData()
	{
		...
		Predmet an = DataManager.createPredmet(new String[] {"1", 	"Matematicka Analiza 1", 	"0", "0", "9"}, null);
		Predmet bp = DataManager.createPredmet(new String[] {"12", 	"Baze Podataka 1", 		 	"0", "2", "8"}, null);
		Predmet ar = DataManager.createPredmet(new String[] {"123", "Arhitektura Racunara", 	"0", "0", "9"}, null);
		Predmet en = DataManager.createPredmet(new String[] {"1234", "Operativni sistemi", 		"0", "0", "8"}, null);
