...
public class Settings {
	...
	public static final String phonePattern			=	"^\\s*(\\d{3}\\/\\d{3}-\\d{3})\\s*$";
	...
	public static final String addressPattern 		= 	"^(\\s*((?!\\d)[\\wćĆčČžŽđĐšŠ]))+(\\,\\s*)(\\d+)(\\,\\s*)(\\s*((?!\\d)[\\wćĆčČžŽđĐšŠ]))+(\\,\\s*)(\\s*((?!\\d)[\\wćĆčČžŽđĐšŠ]))+$";
